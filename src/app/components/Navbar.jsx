...
const Navbar = () => {
  return (
    <nav className="flex flex-row px-3 py-2 relative md:justify-around">
      ...
      <Link href="/about" className="text-xs md:text-lg relative left-5 md:-left-16 md:top-3 lg:-left-28">
        <Image
          src={cat_nav}
          alt="about yomi"
      ...
      <Link href="/yomicosplay" className="text-xs md:text-lg relative left-5 md:-left-[60px] md:top-3 lg:-left-28">
        <Image
          src={cat_nav}
          alt="yomi cosplay"
          className="w-14 h-14 md:w-20 md:h-20 rounded-xl"
      ...
      <Link href="/shorts2" className="text-xs md:text-lg relative left-5 md:-left-14 md:top-3 lg:-left-28">
        <Image
          src={cat_nav}
          alt="yomi reactions"
          className="w-14 h-14 md:w-20 md:h-20 rounded-xl"
